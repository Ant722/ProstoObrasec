...
public class EmployeeNotFoundByPassportIdException extends RuntimeException{
    ...
    public static final String NOT_FOUND_BY_PASSPORTID_MESSAGE= "No employee found with current passportId: (%s)";

    public EmployeeNotFoundByPassportIdException(String passportId){
        super(String.format(NOT_FOUND_BY_PASSPORTID_MESSAGE, passportId));
    }
}
