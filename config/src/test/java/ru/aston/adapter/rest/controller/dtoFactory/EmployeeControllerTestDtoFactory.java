...
@UtilityClass
public class EmployeeControllerTestDtoFactory {
    ...
    public static EmployeeCreateDto getNevValidRegistrationEmployeeRequestDto(){
        ...
        newRegisteredEmployee.setRoleDto(VALID_ROLE);
        newRegisteredEmployee.setStatusDto(VALID_STATUS);
